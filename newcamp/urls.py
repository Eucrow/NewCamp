...
from samples.api import LengthsAPI, SexDetail, SexAPI, SexLengthsAPI
...
urlpatterns = [
    ...
    # Sexes API URLs
    re_path(r'^api/1.0/sexes/(?P<catch_id>[0-9]+)$',
            SexesAPI.as_view(), name="retrieve_sexes_api"),
    path('api/1.0/sex/<int:pk>', SexDetail.as_view(),
         name="retrieve_update_delete_sex_api"),
