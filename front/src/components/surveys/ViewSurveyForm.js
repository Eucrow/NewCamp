	...
	const renderedSurvey = (
		<form className="wrapper form__row">
			<div className="form__row">
				...
				<label className="form__cell">
					Acronym:
					<input type="text" id="acronym" name="acronym" value={survey.acronym || ""} disabled={true} />
				</label>
			</div>
			<div className="form__row">
				<label className="form__cell">
				...
				<label className="form__cell">
					End date:
					<input type="date" id="end_date" name="end_date" value={survey.end_date || ""} disabled={true} />
				</label>
			</div>
			<div className="form__row">
				<label className="form__cell">
					Ship:
					<input type="text" id="ship" name="ship" value={survey.ship || ""} disabled={true} />
				</label>
				<label className="form__cell">
