...
class Haul extends Component {
	...
	constructor(props) {
		...
		this.apiTrawlHaul = "http://127.0.0.1:8000/api/1.0/haul/trawl/" + this.props.haul_id;
		this.apiHydrographyHaul = "http://127.0.0.1:8000/api/1.0/haul/hydrography/" + this.props.haul_id;
	...
	componentDidMount() {
		const apiHaul =
			this.state.sampler_id === 1
				? this.apiTrawlHaul
				: this.state.sampler_id === 2
	...
	render() {
		return this.renderContent(console.log(this.state.haul));
