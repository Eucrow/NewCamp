        ...
        if (isEdit === true){
            return (
                <form>
                    ...
                    <input type="text" id="id" name="id" value={this.state.data.id || ""} onChange={this.handleChange} />
                    <label htmlFor="start_date">acronym: </label>
                    <input type="text" id="acronym" name="acronym" value={this.state.data.acronym || ""} onChange={this.handleChange} />
                    <label htmlFor="start_date">description: </label>
                    <input type="text" id="description" name="description" value={this.state.data.description || ""} onChange={this.handleChange} />
                    <label htmlFor="start_date">start_date: </label>
                    <input type="text" id="start_date" name="start_date" value={this.state.data.start_date || ""} onChange={this.handleChange} />
                    <label htmlFor="end_date">end_date: </label>
                    <input type="text" id="end_date" name="end_date" value={this.state.data.end_date || ""} onChange={this.handleChange} />
                    <label htmlFor="width_x">width_x: </label>
                    <input type="text" id="width_x" name="width_x" value={this.state.data.width_x || ""} onChange={this.handleChange} />
                    <label htmlFor="width_y">width_y: </label>
                    <input type="text" id="width_y" name="width_y" value={this.state.data.width_y || ""} onChange={this.handleChange} />
                    <label htmlFor="origin_x">origin_x: </label>
                    <input type="text" id="origin_x" name="origin_x" value={this.state.data.origin_x || ""} onChange={this.handleChange} />
                    <label htmlFor="origin_y">origin_y: </label>
                    <input type="text" id="origin_y" name="origin_y" value={this.state.data.origin_y || ""} onChange={this.handleChange} />
                    <label htmlFor="ship">ship: </label>
                    <input type="text" id="ship" name="ship" value={this.state.data.ship || ""} onChange={this.handleChange} />
                    <label htmlFor="hauls_duration">hauls_duration: </label>
                    <input type="text" id="hauls_duration" name="hauls_duration" value={this.state.data.hauls_duration ||""} onChange={this.handleChange} />
                    <label htmlFor="unit_sample">unit_sample: </label>
                    <input type="text" id="unit_sample" name="unit_sample" value={this.state.data.unit_sample ||""} onChange={this.handleChange} />
                    ...
                    <input type="text" id="stratification_id" name="stratification_id" value={this.state.data.stratification_id ||""} />
                    <input type="submit" value="Save Survey" onClick={this.handleSubmit} />
                </form>
            )
...
export default ComponentsSurvey;