...
export const haulService = {
	...
	async getTrawlByHaulId(haulId) {
		const apiUrl = buildApiUrl(API_CONFIG.ENDPOINTS.GET_TRAWL_BY_HAUL_ID(haulId));
	...
	async getHydrographyByHaulId(haulId) {
		const apiUrl = buildApiUrl(API_CONFIG.ENDPOINTS.GET_HYDROGRAPHY_BY_HAUL_ID(haulId));
	...
	async updateTrawl(trawlData, haulId) {
		const apiTrawl = buildApiUrl(API_CONFIG.ENDPOINTS.GET_TRAWL_BY_HAUL_ID(haulId));
	...
	async updateHydrography(hydrographyData, haulId) {
		const apiHydrography = buildApiUrl(API_CONFIG.ENDPOINTS.GET_HYDROGRAPHY_BY_HAUL_ID(haulId));
	...
	async updateMeteorology(meteorologyData, haulId) {
		const apiMeteorology = buildApiUrl(API_CONFIG.ENDPOINTS.GET_METEOROLOGY_BY_HAUL_ID(haulId));
